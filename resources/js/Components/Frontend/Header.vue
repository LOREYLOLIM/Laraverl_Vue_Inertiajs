    ...
    <nav class="bg-light-primary border-gray-200 dark:bg-dark-primary">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center">
                <img src="https://cdn.shopify.com/s/files/1/0575/4172/2291/files/Lorex-Logo-Blue-omptimized.png?height=628&pad_color=fff&v=1632805477&width=1200" class="h-8 mr-3" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Lorex</span>
            </a>
            ...
            <div class="w-full md:block md:w-auto" :class="{hidden : showMobileMenu}" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-light-tail-500 dark:border-dark-navy-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0">
                    <li>
